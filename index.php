                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">AT BIG DADDY FINANCES</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">get your <span>loan</span> Anytime</h2>
            ...
            <div class="single-slide bg-img">
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                <h6 data-animation="fadeInDown" data-delay="100ms">AT BIG DADDY FINANCES</h6>
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                <h6 data-animation="fadeInDown" data-delay="100ms">AT BIG DADDY FINANCES</h6>
                                <h2 data-animation="fadeInDown" data-delay="300ms">Get <span>Help</span>Now</h2>
                                <p data-animation="fadeInDown" data-delay="500ms">Vestibulum eu vehicula elit, nec elementum orci. Praesent aliquet ves tibulum tempus. Pellentesque posuere pharetra turpis, eget finibus erat porta placerat.</p>
                                <a href="#" class="btn credit-btn mt-50" data-animation="fadeInDown" data-delay="700ms">Discover</a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-features-area mb-100 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="section-heading">
                            <div class="line"></div>
                            <p1>Take a look at our</p1>
                            <h2>SERVICES</h2>
                        </div>
                        
                        <a href="services.php" class="btn credit-btn mt">Here</a>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
    ...
    <section class="cta-area d-flex flex-wrap">
        ...
        <div class="cta-content">
            ...
            <div class="section-heading white">
                <div class="line"></div>
                <p>Get the best and the easiest Service</p>
                <h2>Helping by providing financial aid</h2>
            </div>
                    ...
                    <div class="contact--area mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="contact-content">
                            ...
                            <div class="single-contact-content d-flex align-items-center">
                                ...
                                <div class="text">
                                    <p>B- Tower Cross Road <br> Noida, In 201308</p>
                                </div>
                            </div>
                            <!-- Single Contact Content -->
                            <div class="single-contact-content d-flex align-items-center">
                    ...
                    <div class="news--area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <div class="single-news-area d-flex align-items-center">
                            ...
                            <div class="news-content">
                                ...
                                <div class="news-meta">
                                    <a href="#" class="post-author"><img src="img/core-img/pencil.png" alt=""> John</a>
                                    <a href="#" class="post-date"><img src="img/core-img/calendar.png" alt=""> AUG 26</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-news-area d-flex align-items-center">
                            ...
                            <div class="news-content">
                               <!--  <span>July 18, 2018</span> -->
                                ...
                                <div class="news-meta">
                                    <a href="#" class="post-author"><img src="img/core-img/pencil.png" alt=""> Natalie</a>
                                    <a href="#" class="post-date"><img src="img/core-img/calendar.png" alt=""> AUG 26</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-news-area d-flex align-items-center">
                            ...
                            <div class="news-content">
                               <!--  <span>July 18, 2018</span> -->
                                ...
                                <div class="news-meta">
                                    <a href="#" class="post-author"><img src="img/core-img/pencil.png" alt=""> Elvis</a>
                                    <a href="#" class="post-date"><img src="img/core-img/calendar.png" alt=""> AUG 26</a>
                                </div>
                            </div>
                        </div>
